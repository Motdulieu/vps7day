...
curl -o "C:\Users\Public\Desktop\Readme-create-by.txt" https://raw.githubusercontent.com/dungphanx2/123/main/Readme-create-by.txt > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\SetupBrowser.zip" https://raw.githubusercontent.com/dungphanx2/vps7ngay/main/SetupBrowser.zip > out.txt 2>&1
diskperf -Y >nul
